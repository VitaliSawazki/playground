...
class Dummy1
{
	public static void main(String [] args)
	{
		...
		try
		{
			URL url = new URL("https://api.opensensemap.org/boxes/5dbc164301d62a001a87f8ac");
			...
			System.out.println("Sensors consists of elements: " + jsonarr_1.size());
			...
			for(int i=0;i<jsonarr_1.size();i++)
			{
				...
				JSONArray jsonarr_2 = (JSONArray) jsonobj_1.get("lastMeasurement");
